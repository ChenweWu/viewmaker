...
from src.systems import ecg_1d_systems
...
SYSTEM = {
    'PretrainViewMakerSystem': ecg_1d_systems.PretrainViewMakerSystem,
    'TransferViewmakerSystem': ecg_1d_systems.TransferViewMakerSystem,
    'PretrainExpertSimCLRSystem': ecg_1d_systems.PretrainExpertSimCLRSystem,
    'TransferExpertSystem': ecg_1d_systems.TransferExpertSystem,
}
